    ...
    render(){
        return(
            <div className="no-trip">
                <h4>TTN-SPLITWISE</h4>
                <p>-><span>TTN-SPLITWISE</span> is an application which let's the user to keep track of all the expenditure he/she made.</p>
                ...
                <img src="https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcRbF5NqYnHs5Rmt3Xh3cXWw67Ckmg_oK6tkD2tiKfXYC6E3BCTG"
                     alt="Home img"/>
            </div>
        );
    }
